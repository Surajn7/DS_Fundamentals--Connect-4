...
public:
  Rules() {
    ...
    cout << "2.In each step choose in which column number in which you want to "
            "mark \n";
    cout << "\n \n P.S : Rows will be filled from bottom to top in any column "
            "\n\n\n";
  }
};
...
// P.S: As per the assignment logic is checking for bottom row and column if it
// is occupied then it is asking player to give other column and mark it above
// row (row-1)